...
($context["attributes"] ?? null), "class", [], "any", false, false, true, 8))) ? ("w-full") : ("")), ((CoreExtension::inFilter("content-map", CoreExtension::getAttribute($this->env, $this->source,         // line 9
...
\t\t\t\t<div class=\"grid gap-5 grid-cols-[repeat(auto-fit,minmax(250px,1fr))] place-items-center\">
\t\t\t\t\t";
                // line 38
...
\t\t\t</div>
\t\t";
            } elseif (CoreExtension::inFilter("about-us-pic", CoreExtension::getAttribute($this->env, $this->source,             // line 41
($context["attributes"] ?? null), "class", [], "any", false, false, true, 41))) {
                // line 42
                yield "\t\t\t<div class=\"about-us-pic\">
\t\t\t\t<div class=\"grid gap-5 grid-cols-[repeat(auto-fit,minmax(250px,1fr))] place-items-center\">
\t\t\t\t\t";
                // line 44
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["rows"] ?? null), "html", null, true);
...
\t\t\t</div>
\t\t";
            } elseif (CoreExtension::inFilter("most-liked", CoreExtension::getAttribute($this->env, $this->source,             // line 46
($context["attributes"] ?? null), "class", [], "any", false, false, true, 46))) {
                // line 47
                yield "\t\t\t<div class=\"most-liked\">
...
\t\t\t</div>
\t\t";
            } elseif (CoreExtension::inFilter("most-recent", CoreExtension::getAttribute($this->env, $this->source,             // line 54
($context["attributes"] ?? null), "class", [], "any", false, false, true, 54))) {
                // line 55
                yield "\t\t\t<div class=\"most-recent\">
\t\t\t\t<div class=\"flex overflow-y-auto [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden\">
\t\t\t\t\t<div class=\"flex  items-stretch p-4 gap-3\">
\t\t\t\t\t\t";
                // line 58
...
";
    ...
    {
        return array (  245 => 95,  239 => 92,  236 => 91,  233 => 90,  227 => 87,  224 => 86,  221 => 85,  215 => 83,  212 => 82,  206 => 79,  203 => 78,  200 => 77,  194 => 75,  192 => 74,  188 => 72,  182 => 69,  179 => 68,  176 => 67,  170 => 64,  167 => 63,  159 => 58,  154 => 55,  152 => 54,  145 => 50,  140 => 47,  138 => 46,  133 => 44,  129 => 42,  127 => 41,  121 => 38,  117 => 36,  114 => 35,  112 => 34,  109 => 33,  103 => 30,  100 => 29,  97 => 28,  91 => 25,  88 => 24,  85 => 23,  79 => 20,  76 => 19,  74 => 18,  69 => 17,  63 => 15,  61 => 14,  57 => 13,  52 => 12,  50 => 9,  49 => 8,  48 => 7,  47 => 6,  46 => 5,  45 => 4,  44 => 2,);
    }
  ...
  set classes = [
    ...
    'all-content' in attributes.class ? 'w-full',
...
\t\t\t\t</div>
\t\t\t</div>
\t\t{% elseif 'about-us-pic' in attributes.class %}
\t\t\t<div class=\"about-us-pic\">
\t\t\t\t<div class=\"grid gap-5 grid-cols-[repeat(auto-fit,minmax(250px,1fr))] place-items-center\">
\t\t\t\t\t{{ rows }}
\t\t\t</div>
\t\t{% elseif 'most-liked' in attributes.class %}
...
\t\t\t\t</div>
\t\t\t</div>
\t\t{% elseif 'most-recent' in attributes.class %}
